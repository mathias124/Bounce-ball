...
void draw(){
 ...
 rect(200,200,800+speed,800+speed);
...
if(y<38) {
  up=false;
  down=true;// PS kunne ikke helt finde ud af at hvilken "kommand" man skulle bruge til at gøre så min kugle bounced på rectanglen.
}
}
